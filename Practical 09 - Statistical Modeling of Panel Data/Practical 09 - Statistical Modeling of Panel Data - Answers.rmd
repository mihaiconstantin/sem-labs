...
```{r size="footnotesize", dev="pdf", fig.width=20, fig.height=12, out.width="450px", fig.align="center"}
# Model syntax.
...
# Visualize the model.
semPaths(model_ex_1_quasi_simplex_alt_fit, what = "paths", whatLabels = "est")
```
