...
Some of you indicated that the $\chi^2$ difference value in the LRT computation
is not the same as the actual difference between the standard $\chi^2$ reported
by `lavaan` (e.g., during model `summary()`).
