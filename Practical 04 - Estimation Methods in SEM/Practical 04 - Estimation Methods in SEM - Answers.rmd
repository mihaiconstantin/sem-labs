...
particular points (i.e., see Figure 3).
...
variables need to be ordinal when the `WLSMV` estimator is used. We can have a
mix of ordinal and continuous variables. However, for those that we indicated as
ordinal via the `ordered` argument, `lavaan` will use the procedure presented
above.
